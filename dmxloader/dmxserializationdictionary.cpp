...
//-----------------------------------------------------------------------------
DmxSerializationHandle_t CDmxSerializationDictionary::Find( CDmxElement* pElement ) const
{
...
void CDmxSerializationDictionary::BuildElementList_R( CDmxElement* pElement, bool bFlatMode, bool bIsRoot )
{
	...
	if ( h != CUtlRBTree<DmxElementInfo_t, DmxSerializationHandle_t>::InvalidIndex() )
	{
...
int CDmxSerializationDictionary::RootElementCount() const
{
	...
	while( h != CUtlRBTree<DmxElementInfo_t, DmxSerializationHandle_t>::InvalidIndex() )
	{
		if ( m_Dict[h].m_bRoot )
			++nCount;
