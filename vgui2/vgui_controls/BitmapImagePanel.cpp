...
void CBitmapImagePanel::ApplySettings(KeyValues *inResourceData)
{
	...
	m_preserveAspectRatio = inResourceData->GetBool("preserveAspectRatio");
	m_hardwareFiltered = inResourceData->GetBool("filtered");
