...
// Purpose: Changes the current list selection
//-----------------------------------------------------------------------------
void SectionedListPanel::SetHighlightedItem(CItemButton *item)
{
	if ( m_hHighlightedItem.Get() == item)
		return;

	// deselect the current item
	if ( m_hHighlightedItem.Get())
	{
		m_hHighlightedItem->SetHighlighted(false);
	}

	// set the new item
	m_hHighlightedItem = item;
	if ( m_hHighlightedItem.Get())
	{
		m_hHighlightedItem->SetHighlighted(true);
	}
...
// Purpose: sets which item is currently selected
//-----------------------------------------------------------------------------
void SectionedListPanel::SetHighlightedItem(int itemID)
{
	if ( m_Items.IsValidIndex(itemID) )
	{
		SetHighlightedItem(m_Items[itemID]);
	}
}
