...
ScalableImagePanel::~ScalableImagePanel()
{
	...
	{
		vgui::surface()->DeleteTextureByID( m_iTextureID );
		m_iTextureID = -1;
	}
}
...
{
	if ( imageName && *imageName && !m_pszImageName.IsEmpty() && m_pszImageName.IsEqual_CaseInsensitive( imageName ) )
		return;
