...
{
	PixRGBA8 x;
	x.Red = clamp( 255.0f * f.Red, 0.0f, 255.0f );
	x.Green = clamp( 255.0f * f.Green, 0.0f, 255.0f );
	x.Blue = clamp( 255.0f * f.Blue, 0.0f, 255.0f );
	x.Alpha = clamp( 255.0f * f.Alpha, 0.0f, 255.0f );
	return x;
}
