...
public:
	...
	virtual bool OnJSAlert( const char *pMsg ) { return false; } // Called on this browser getting a JS alert
...
private:
	...
	FORCEINLINE bool IsCurrentBrowser( HHTMLBrowser other ) const { return m_unBrowserHandle != INVALID_HTMLBROWSER && other == m_unBrowserHandle; }
};
