...
public:
	...
	void SetText( const CUtlString& text, const CUtlString& extra );
	bool HasExtra() const { return m_bHasExtra; }
...
protected:
	...
	void AddToHistory( const CUtlString& commandText, const CUtlString& extraText );
